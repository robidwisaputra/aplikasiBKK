...
<?php echo form_open_multipart('admin/loker/import_loker_proses/',array('role'=>'form','id'=>'fform'));?>
<div class="box box-primary">
						
  				<div class="box-header with-border">
				
					<button type="submit" name="upload" class="btn btn-info"><i class="glyphicon glyphicon-upload"></i> Import</button>
					<a href="<?php echo site_url('admin/loker/excel_kosong');?>" class="btn btn-success"><i class="glyphicon glyphicon-download"></i> Download Template</a>
