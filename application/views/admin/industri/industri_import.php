...
<div class="box box-primary">
  				...
  				<div class="box-header with-border">
					...
					<a href="<?php echo site_url('admin/industri/excel_kosong');?>" class="btn btn-success"><i class="glyphicon glyphicon-download"></i> Template</a>
  				...
  				<div class="box-body">
                    ...
                    <label for="inputEmail3" class="col-sm-2 control-label">Data Industri (xls)</label>
                    <div class="col-sm-8">
